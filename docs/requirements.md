...
| FR-177 | Leaderboard nach Wertdimension filtern | Als Mitglied möchte ich die Rangliste auch nach einer ganzen Wertdimension («Ehrenamt») eingrenzen und die Säulen unter diesen Namen gruppiert sehen, damit Rangliste und «Meine Stärken» dasselbe Vokabular tragen. | Medium   | Implemented |
