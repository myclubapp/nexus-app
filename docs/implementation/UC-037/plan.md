...
| 2026-09-11 | **Befund der Vision-Prüfung (B2):** 27 von 31 `EmptyState` trugen kein Angebot – FR-144 war zu optimistisch. Jetzt trägt jeder Leerzustand auf einer Seite ein `action` (Formular öffnen, Filter zurücksetzen, zur Agenda/zum Marktplatz/zum Profil); vier Leerzustände in Blättern bleiben Erklärung, weil ihr nächster Schritt das Schliessen ist. `emptyStateAction.test.ts` hält die Regel fest; guidelines §3 nennt sie |
